...
_065:
    ...
    CompareVarToValue OPCODE_EQU, BTLVAR_CURRENT_MOVE, MOVE_POISON_POWDER, _070
    GoTo _071

_070:
    CompareMonDataToValue OPCODE_EQU, BTLSCR_DEFENDER, BATTLEMON_TYPE_1, TYPE_GRASS, _266
    CompareMonDataToValue OPCODE_EQU, BTLSCR_DEFENDER, BATTLEMON_TYPE_2, TYPE_GRASS, _266
    CheckIgnorableAbility CHECK_HAVE, BTLSCR_DEFENDER, ABILITY_OVERCOAT, _266
...
_077:
    CheckAbility CHECK_HAVE, BTLSCR_ATTACKER, ABILITY_INFILTRATOR, _080
    CompareVarToValue OPCODE_FLAG_SET, BTLVAR_SIDE_CONDITIONS_EFFECT_MON, SIDE_CONDITION_SAFEGUARD, _294
    CompareVarToValue OPCODE_EQU, BTLVAR_SIDE_EFFECT_TYPE, SIDE_EFFECT_TYPE_INDIRECT, _085
...
_130:
    ...
    // {0} was poisoned!
    PrintMessage pl_msg_00000368_00063, TAG_NICKNAME, BTLSCR_SIDE_EFFECT_MON
    GoTo _156

_150:
    // {0}’s {1} poisoned {2}!
    PrintMessage pl_msg_00000368_00066, TAG_NICKNAME_ABILITY_NICKNAME, BTLSCR_MSG_TEMP, BTLSCR_MSG_BATTLER_TEMP, BTLSCR_SIDE_EFFECT_MON
