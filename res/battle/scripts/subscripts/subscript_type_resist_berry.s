...
_000:
    ...
    CompareVarToValue OPCODE_EQU, BTLVAR_CURRENT_MOVE, MOVE_STRUGGLE, _262
    CompareVarToValue OPCODE_EQU, BTLVAR_CURRENT_MOVE, MOVE_JUDGMENT, _020
    CompareVarToValue OPCODE_EQU, BTLVAR_CURRENT_MOVE, MOVE_NATURAL_GIFT, _020
    CompareVarToValue OPCODE_EQU, BTLVAR_CURRENT_MOVE, MOVE_HIDDEN_POWER, _020
    CompareVarToValue OPCODE_EQU, BTLVAR_CURRENT_MOVE, MOVE_WEATHER_BALL, _020
    CheckAbility CHECK_NOT_HAVE, BTLSCR_ATTACKER, ABILITY_NORMALIZE, _ate_check
    UpdateVar OPCODE_SET, BTLVAR_CALC_TEMP, 0x00000000
    GoTo _033

_ate_check:
    GetCurrentMoveData MOVEATTRIBUTE_TYPE
    CompareVarToValue OPCODE_NEQ, BTLVAR_CALC_TEMP, TYPE_NORMAL, _020
    CheckAbility CHECK_HAVE, BTLSCR_ATTACKER, ABILITY_AERILATE, _ate_flying
    CheckAbility CHECK_HAVE, BTLSCR_ATTACKER, ABILITY_REFRIGERATE, _ate_ice
    CheckAbility CHECK_HAVE, BTLSCR_ATTACKER, ABILITY_PIXILATE, _ate_fairy
    CheckAbility CHECK_HAVE, BTLSCR_ATTACKER, ABILITY_DRAGONIZE, _ate_dragon
    CheckAbility CHECK_HAVE, BTLSCR_ATTACKER, ABILITY_GALVANIZE, _ate_electric
    GoTo _020

_ate_flying:
    UpdateVar OPCODE_SET, BTLVAR_CALC_TEMP, TYPE_FLYING
    GoTo _033

_ate_ice:
    UpdateVar OPCODE_SET, BTLVAR_CALC_TEMP, TYPE_ICE
    GoTo _033
...
_ate_dragon:
    UpdateVar OPCODE_SET, BTLVAR_CALC_TEMP, TYPE_DRAGON
    GoTo _033

_ate_electric:
    UpdateVar OPCODE_SET, BTLVAR_CALC_TEMP, TYPE_ELECTRIC
    GoTo _033
...
_033:
    ...
    CompareVarToValue OPCODE_EQU, BTLVAR_SCRIPT_TEMP, 149, _243
    GoTo _262
...
_240:
    CompareVarToValue OPCODE_EQU, BTLVAR_CALC_TEMP, 0x00000008, _245
    GoTo _262

_243:
    CompareVarToValue OPCODE_EQU, BTLVAR_CALC_TEMP, 0x00000009, _245
    GoTo _262
