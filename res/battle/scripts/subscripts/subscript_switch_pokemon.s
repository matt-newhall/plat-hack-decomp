...
_000:
    TryRestoreStatusOnSwitch BTLSCR_SWITCHED_MON, _003
    UpdateMonData OPCODE_SET, BTLSCR_SWITCHED_MON, BATTLEMON_STATUS, MON_CONDITION_NONE
    GoTo _007

_003:
    TryRegeneratorOnSwitch BTLSCR_SWITCHED_MON, _007
    UpdateMonDataFromVar OPCODE_GET, BTLSCR_SWITCHED_MON, BATTLEMON_MAX_HP, BTLVAR_HP_CALC_TEMP
    DivideVarByValue BTLVAR_HP_CALC_TEMP, 3
    UpdateHealthBarValue BTLSCR_SWITCHED_MON
