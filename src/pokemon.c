...
static const MegaEvolution sMegaEvolutions[] = {
    ...
    { ITEM_CLEFABLITE, SPECIES_CLEFABLE, CLEFABLE_FORM_BASE, CLEFABLE_FORM_MEGA, 423, 0, 5 },
    ...
    { ITEM_AERODACTYLITE, SPECIES_AERODACTYL, AERODACTYL_FORM_BASE, AERODACTYL_FORM_MEGA, 790, 0, 0 },
    ...
    { ITEM_VICTREEBELITE, SPECIES_VICTREEBEL, VICTREEBEL_FORM_BASE, VICTREEBEL_FORM_MEGA, 1255, 0, 0 },
    ...
    { ITEM_STARMINITE, SPECIES_STARMIE, STARMIE_FORM_BASE, STARMIE_FORM_MEGA, 800, 0, 0 },
