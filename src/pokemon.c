...
static const MegaEvolution sMegaEvolutions[] = {
    ...
    { ITEM_GLALITITE, SPECIES_GLALIE, GLALIE_FORM_BASE, GLALIE_FORM_MEGA, 3502, 0, 0 },
    { ITEM_SALAMENCITE, SPECIES_SALAMENCE, SALAMENCE_FORM_BASE, SALAMENCE_FORM_MEGA, 1126, 0, 0 },
    { ITEM_LOPUNNITE, SPECIES_LOPUNNY, LOPUNNY_FORM_BASE, LOPUNNY_FORM_MEGA, 283, 0, 0 },
    { ITEM_GARCHOMPITE, SPECIES_GARCHOMP, GARCHOMP_FORM_BASE, GARCHOMP_FORM_MEGA, 950, 0, 0 },
    { ITEM_ABOMASITE, SPECIES_ABOMASNOW, ABOMASNOW_FORM_BASE, ABOMASNOW_FORM_MEGA, 1850, 0, 0 },
