...
static const MegaEvolution sMegaEvolutions[] = {
    ...
    { ITEM_DRAGONINITE, SPECIES_DRAGONITE, DRAGONITE_FORM_BASE, DRAGONITE_FORM_MEGA, 2900, 0, 0 },
    { ITEM_CLEFABLITE, SPECIES_CLEFABLE, CLEFABLE_FORM_BASE, CLEFABLE_FORM_MEGA, 423, 0, 0 },
