...
void BuildPokemonSpriteTemplate(PokemonSpriteTemplate *spriteTemplate, u16 species, u8 gender, u8 face, u8 shiny, u8 form, u32 personality)
{
    ...
    case SPECIES_VENUSAUR:
        ...
        spriteTemplate->palette = 429 + shiny + form * 2;
        break;

    case SPECIES_CHARIZARD:
        spriteTemplate->narcID = NARC_INDEX_POKETOOL__POKEGRA__PL_OTHERPOKE;
        spriteTemplate->character = 255 + (face / 2) + form * 2;
        spriteTemplate->palette = 433 + shiny + form * 2;
        break;
    ...
    case SPECIES_SCIZOR:
        ...
        spriteTemplate->palette = 495 + shiny + form * 2;
        break;
...
static const MegaEvolution sMegaEvolutions[] = {
    ...
    { ITEM_RAICHUNITE_Y, SPECIES_RAICHU, RAICHU_FORM_BASE, RAICHU_FORM_MEGA_Y, 260, 0, 0 },
    { ITEM_MEWTWONITE_X, SPECIES_MEWTWO, MEWTWO_FORM_BASE, MEWTWO_FORM_MEGA_X, 1270, 0, 0 },
    { ITEM_MEWTWONITE_Y, SPECIES_MEWTWO, MEWTWO_FORM_BASE, MEWTWO_FORM_MEGA_Y, 330, 0, 0 },
    { ITEM_LATIOSITE, SPECIES_LATIOS, LATIOS_FORM_BASE, LATIOS_FORM_MEGA, 700, 0, 0 },
    { ITEM_LATIASITE, SPECIES_LATIAS, LATIAS_FORM_BASE, LATIAS_FORM_MEGA, 520, 0, 0 },
};
...
u8 LoadPokemonSpriteYOffset(u16 species, u8 gender, u8 face, u8 form, u32 personality)
{
    ...
    case SPECIES_ABSOL:
        if (form == ABSOL_FORM_MEGA && face == FACE_FRONT) {
            return 1;
        }
