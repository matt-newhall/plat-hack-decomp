...
static const MegaEvolution sMegaEvolutions[] = {
    { ITEM_LUCARIONITE, SPECIES_LUCARIO, LUCARIO_FORM_BASE, LUCARIO_FORM_MEGA, 575, 0, 0 },
    { ITEM_LUCARIONITE_Z, SPECIES_LUCARIO, LUCARIO_FORM_BASE, LUCARIO_FORM_MEGA_Z, 494, 0, 7 },
    { ITEM_TYRANITARITE, SPECIES_TYRANITAR, TYRANITAR_FORM_BASE, TYRANITAR_FORM_MEGA, 2550, 0, 0 },
    { ITEM_VENUSAURITE, SPECIES_VENUSAUR, VENUSAUR_FORM_BASE, VENUSAUR_FORM_MEGA, 1555, 0, 0 },
    { ITEM_BLASTOISINITE, SPECIES_BLASTOISE, BLASTOISE_FORM_BASE, BLASTOISE_FORM_MEGA, 1011, 15, 0 },
    { ITEM_BEEDRILLITE, SPECIES_BEEDRILL, BEEDRILL_FORM_BASE, BEEDRILL_FORM_MEGA, 405, 0, 0 },
    { ITEM_PIDGEOTITE, SPECIES_PIDGEOT, PIDGEOT_FORM_BASE, PIDGEOT_FORM_MEGA, 505, 0, 0 },
    { ITEM_SLOWBRONITE, SPECIES_SLOWBRO, SLOWBRO_FORM_BASE, SLOWBRO_FORM_MEGA, 1200, 0, 0 },
    { ITEM_GENGARITE, SPECIES_GENGAR, GENGAR_FORM_BASE, GENGAR_FORM_MEGA, 405, 2, 0 },
    { ITEM_PINSIRITE, SPECIES_PINSIR, PINSIR_FORM_BASE, PINSIR_FORM_MEGA, 590, -4, 0 },
    { ITEM_AMPHAROSITE, SPECIES_AMPHAROS, AMPHAROS_FORM_BASE, AMPHAROS_FORM_MEGA, 615, -8, 0 },
    { ITEM_STEELIXITE, SPECIES_STEELIX, STEELIX_FORM_BASE, STEELIX_FORM_MEGA, 7400, 0, 0 },
    { ITEM_SCIZORITE, SPECIES_SCIZOR, SCIZOR_FORM_BASE, SCIZOR_FORM_MEGA, 1250, 0, 10 },
    { ITEM_HERACRONITE, SPECIES_HERACROSS, HERACROSS_FORM_BASE, HERACROSS_FORM_MEGA, 625, 0, 0 },
    { ITEM_HOUNDOOMINITE, SPECIES_HOUNDOOM, HOUNDOOM_FORM_BASE, HOUNDOOM_FORM_MEGA, 495, 0, 0 },
    { ITEM_SCEPTILITE, SPECIES_SCEPTILE, SCEPTILE_FORM_BASE, SCEPTILE_FORM_MEGA, 552, 19, 0 },
    { ITEM_BLAZIKENITE, SPECIES_BLAZIKEN, BLAZIKEN_FORM_BASE, BLAZIKEN_FORM_MEGA, 520, -4, 3 },
    { ITEM_SWAMPERTITE, SPECIES_SWAMPERT, SWAMPERT_FORM_BASE, SWAMPERT_FORM_MEGA, 1020, 16, 0 },
    { ITEM_SABLENITE, SPECIES_SABLEYE, SABLEYE_FORM_BASE, SABLEYE_FORM_MEGA, 1610, 10, 8 },
    { ITEM_MAWILITE, SPECIES_MAWILE, MAWILE_FORM_BASE, MAWILE_FORM_MEGA, 235, 14, 4 },
    { ITEM_AGGRONITE, SPECIES_AGGRON, AGGRON_FORM_BASE, AGGRON_FORM_MEGA, 3950, 0, 0 },
    { ITEM_MEDICHAMITE, SPECIES_MEDICHAM, MEDICHAM_FORM_BASE, MEDICHAM_FORM_MEGA, 315, 0, 0 },
    { ITEM_MANECTITE, SPECIES_MANECTRIC, MANECTRIC_FORM_BASE, MANECTRIC_FORM_MEGA, 440, 0, 0 },
    { ITEM_BANETTITE, SPECIES_BANETTE, BANETTE_FORM_BASE, BANETTE_FORM_MEGA, 130, 0, 6 },
    { ITEM_ALAKAZITE, SPECIES_ALAKAZAM, ALAKAZAM_FORM_BASE, ALAKAZAM_FORM_MEGA, 480, 0, 12 },
    { ITEM_GYARADOSITE, SPECIES_GYARADOS, GYARADOS_FORM_BASE, GYARADOS_FORM_MEGA, 3050, 0, 5 },
    { ITEM_ABSOLITE, SPECIES_ABSOL, ABSOL_FORM_BASE, ABSOL_FORM_MEGA, 490, 0, 0 },
    { ITEM_ABSOLITE_Z, SPECIES_ABSOL, ABSOL_FORM_BASE, ABSOL_FORM_MEGA_Z, 490, 0, 0 },
    { ITEM_GLALITITE, SPECIES_GLALIE, GLALIE_FORM_BASE, GLALIE_FORM_MEGA, 3502, 0, 8 },
    { ITEM_SALAMENCITE, SPECIES_SALAMENCE, SALAMENCE_FORM_BASE, SALAMENCE_FORM_MEGA, 1126, 0, 0 },
    { ITEM_LOPUNNITE, SPECIES_LOPUNNY, LOPUNNY_FORM_BASE, LOPUNNY_FORM_MEGA, 283, 0, 4 },
    { ITEM_GARCHOMPITE, SPECIES_GARCHOMP, GARCHOMP_FORM_BASE, GARCHOMP_FORM_MEGA, 950, 0, 0 },
    { ITEM_GARCHOMPITE_Z, SPECIES_GARCHOMP, GARCHOMP_FORM_BASE, GARCHOMP_FORM_MEGA_Z, 990, 0, 0 },
    { ITEM_ABOMASITE, SPECIES_ABOMASNOW, ABOMASNOW_FORM_BASE, ABOMASNOW_FORM_MEGA, 1850, 0, 2 },
    { ITEM_GALLADITE, SPECIES_GALLADE, GALLADE_FORM_BASE, GALLADE_FORM_MEGA, 564, 0, 0 },
    { ITEM_GARDEVOIRITE, SPECIES_GARDEVOIR, GARDEVOIR_FORM_BASE, GARDEVOIR_FORM_MEGA, 484, 0, 0 },
    { ITEM_ALTARIANITE, SPECIES_ALTARIA, ALTARIA_FORM_BASE, ALTARIA_FORM_MEGA, 206, 0, 0 },
    { ITEM_SHARPEDONITE, SPECIES_SHARPEDO, SHARPEDO_FORM_BASE, SHARPEDO_FORM_MEGA, 1303, 0, 0 },
    { ITEM_DRAGONINITE, SPECIES_DRAGONITE, DRAGONITE_FORM_BASE, DRAGONITE_FORM_MEGA, 2900, 0, 5 },
    { ITEM_CLEFABLITE, SPECIES_CLEFABLE, CLEFABLE_FORM_BASE, CLEFABLE_FORM_MEGA, 423, -7, 5 },
    { ITEM_FROSLASSITE, SPECIES_FROSLASS, FROSLASS_FORM_BASE, FROSLASS_FORM_MEGA, 296, 0, 0 },
    ...
    { ITEM_RAICHUNITE_Y, SPECIES_RAICHU, RAICHU_FORM_BASE, RAICHU_FORM_MEGA_Y, 260, 7, 11 },
    { ITEM_RAICHUNITE_X, SPECIES_RAICHU, RAICHU_FORM_BASE, RAICHU_FORM_MEGA_X, 380, -4, 4 },
    { ITEM_MEWTWONITE_X, SPECIES_MEWTWO, MEWTWO_FORM_BASE, MEWTWO_FORM_MEGA_X, 1270, -5, 2 },
    { ITEM_MEWTWONITE_Y, SPECIES_MEWTWO, MEWTWO_FORM_BASE, MEWTWO_FORM_MEGA_Y, 330, -7, 7 },
    { ITEM_LATIOSITE, SPECIES_LATIOS, LATIOS_FORM_BASE, LATIOS_FORM_MEGA, 700, 0, 0 },
    { ITEM_LATIASITE, SPECIES_LATIAS, LATIAS_FORM_BASE, LATIAS_FORM_MEGA, 520, 0, 4 },
    { ITEM_AERODACTYLITE, SPECIES_AERODACTYL, AERODACTYL_FORM_BASE, AERODACTYL_FORM_MEGA, 790, 2, 0 },
    { ITEM_METAGROSSITE, SPECIES_METAGROSS, METAGROSS_FORM_BASE, METAGROSS_FORM_MEGA, 9429, 0, 8 },
    { ITEM_FERALIGITE, SPECIES_FERALIGATR, FERALIGATR_FORM_BASE, FERALIGATR_FORM_MEGA, 1088, 3, 3 },
    { ITEM_VICTREEBELITE, SPECIES_VICTREEBEL, VICTREEBEL_FORM_BASE, VICTREEBEL_FORM_MEGA, 1255, -15, 0 },
    { ITEM_MEGANIUMITE, SPECIES_MEGANIUM, MEGANIUM_FORM_BASE, MEGANIUM_FORM_MEGA, 2010, 8, 0 },
    { ITEM_SKARMORITE, SPECIES_SKARMORY, SKARMORY_FORM_BASE, SKARMORY_FORM_MEGA, 404, 0, 0 },
    ...
    { ITEM_CAMERUPTITE, SPECIES_CAMERUPT, CAMERUPT_FORM_BASE, CAMERUPT_FORM_MEGA, 3205, 0, 0 },
    { ITEM_STARMINITE, SPECIES_STARMIE, STARMIE_FORM_BASE, STARMIE_FORM_MEGA, 800, 0, 5 },
    { ITEM_CHIMECHITE, SPECIES_CHIMECHO, CHIMECHO_FORM_BASE, CHIMECHO_FORM_MEGA, 80, 0, 0 },
};
