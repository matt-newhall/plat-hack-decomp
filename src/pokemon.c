...
void BuildPokemonSpriteTemplate(PokemonSpriteTemplate *spriteTemplate, u16 species, u8 gender, u8 face, u8 shiny, u8 form, u32 personality)
{
    ...
    case SPECIES_VENUSAUR:
        ...
        spriteTemplate->palette = 487 + shiny + form * 2;
        break;

    case SPECIES_CHARIZARD:
        spriteTemplate->narcID = NARC_INDEX_POKETOOL__POKEGRA__PL_OTHERPOKE;
        spriteTemplate->character = 255 + (face / 2) + form * 2;
        spriteTemplate->palette = 491 + shiny + form * 2;
        break;
    ...
    case SPECIES_BEEDRILL:
        ...
        spriteTemplate->palette = 501 + shiny + form * 2;
        break;

    case SPECIES_PIDGEOT:
        spriteTemplate->narcID = NARC_INDEX_POKETOOL__POKEGRA__PL_OTHERPOKE;
        spriteTemplate->character = 269 + (face / 2) + form * 2;
        spriteTemplate->palette = 505 + shiny + form * 2;
        break;

    case SPECIES_RAICHU:
        spriteTemplate->narcID = NARC_INDEX_POKETOOL__POKEGRA__PL_OTHERPOKE;
        spriteTemplate->character = 273 + (face / 2) + form * 2;
        spriteTemplate->palette = 509 + shiny + form * 2;
        break;
    ...
    case SPECIES_GYARADOS:
        ...
        spriteTemplate->palette = 547 + shiny + form * 2;
        break;

    case SPECIES_AERODACTYL:
        spriteTemplate->narcID = NARC_INDEX_POKETOOL__POKEGRA__PL_OTHERPOKE;
        spriteTemplate->character = 315 + (face / 2) + form * 2;
        spriteTemplate->palette = 551 + shiny + form * 2;
        break;

    case SPECIES_DRAGONITE:
        spriteTemplate->narcID = NARC_INDEX_POKETOOL__POKEGRA__PL_OTHERPOKE;
        spriteTemplate->character = 319 + (face / 2) + form * 2;
        spriteTemplate->palette = 555 + shiny + form * 2;
        break;

    case SPECIES_MEWTWO:
        spriteTemplate->narcID = NARC_INDEX_POKETOOL__POKEGRA__PL_OTHERPOKE;
        spriteTemplate->character = 323 + (face / 2) + form * 2;
        spriteTemplate->palette = 559 + shiny + form * 2;
        break;
    ...
    case SPECIES_SHARPEDO:
        ...
        spriteTemplate->palette = 637 + shiny + form * 2;
        break;

    case SPECIES_CAMERUPT:
        spriteTemplate->narcID = NARC_INDEX_POKETOOL__POKEGRA__PL_OTHERPOKE;
        spriteTemplate->character = 405 + (face / 2) + form * 2;
        spriteTemplate->palette = 641 + shiny + form * 2;
        break;

    case SPECIES_ALTARIA:
        spriteTemplate->narcID = NARC_INDEX_POKETOOL__POKEGRA__PL_OTHERPOKE;
        spriteTemplate->character = 409 + (face / 2) + form * 2;
        spriteTemplate->palette = 645 + shiny + form * 2;
        break;

    case SPECIES_BANETTE:
        spriteTemplate->narcID = NARC_INDEX_POKETOOL__POKEGRA__PL_OTHERPOKE;
        spriteTemplate->character = 413 + (face / 2) + form * 2;
        spriteTemplate->palette = 649 + shiny + form * 2;
        break;

    case SPECIES_CHIMECHO:
        spriteTemplate->narcID = NARC_INDEX_POKETOOL__POKEGRA__PL_OTHERPOKE;
        spriteTemplate->character = 417 + (face / 2) + form * 2;
        spriteTemplate->palette = 653 + shiny + form * 2;
        break;

    case SPECIES_ABSOL:
        spriteTemplate->narcID = NARC_INDEX_POKETOOL__POKEGRA__PL_OTHERPOKE;
        spriteTemplate->character = 421 + (face / 2) + form * 2;
        spriteTemplate->palette = 657 + shiny + form * 2;
        break;
    ...
    case SPECIES_STARAPTOR:
        spriteTemplate->narcID = NARC_INDEX_POKETOOL__POKEGRA__PL_OTHERPOKE;
        spriteTemplate->character = 447 + (face / 2) + form * 2;
    ...
    case SPECIES_LUCARIO:
        spriteTemplate->narcID = NARC_INDEX_POKETOOL__POKEGRA__PL_OTHERPOKE;
        spriteTemplate->character = 461 + (face / 2) + form * 2;
        spriteTemplate->palette = 697 + shiny + form * 2;
        break;

    case SPECIES_ABOMASNOW:
        spriteTemplate->narcID = NARC_INDEX_POKETOOL__POKEGRA__PL_OTHERPOKE;
        spriteTemplate->character = 467 + (face / 2) + form * 2;
        spriteTemplate->palette = 703 + shiny + form * 2;
        break;

    case SPECIES_GALLADE:
        spriteTemplate->narcID = NARC_INDEX_POKETOOL__POKEGRA__PL_OTHERPOKE;
        spriteTemplate->character = 471 + (face / 2) + form * 2;
        spriteTemplate->palette = 707 + shiny + form * 2;
        break;

    case SPECIES_FROSLASS:
        spriteTemplate->narcID = NARC_INDEX_POKETOOL__POKEGRA__PL_OTHERPOKE;
        spriteTemplate->character = 475 + (face / 2) + form * 2;
        spriteTemplate->palette = 711 + shiny + form * 2;
        break;

    case SPECIES_HEATRAN:
        spriteTemplate->narcID = NARC_INDEX_POKETOOL__POKEGRA__PL_OTHERPOKE;
        spriteTemplate->character = 479 + (face / 2) + form * 2;
        spriteTemplate->palette = 715 + shiny + form * 2;
        break;

    case SPECIES_DARKRAI:
        spriteTemplate->narcID = NARC_INDEX_POKETOOL__POKEGRA__PL_OTHERPOKE;
        spriteTemplate->character = 483 + (face / 2) + form * 2;
        spriteTemplate->palette = 719 + shiny + form * 2;
        break;
...
static const MegaEvolution sMegaEvolutions[] = {
    { ITEM_LUCARIONITE, SPECIES_LUCARIO, LUCARIO_FORM_BASE, LUCARIO_FORM_MEGA, 575, 0, 0, -2 },
    { ITEM_LUCARIONITE_Z, SPECIES_LUCARIO, LUCARIO_FORM_BASE, LUCARIO_FORM_MEGA_Z, 494, 0, 7, 2 },
    { ITEM_TYRANITARITE, SPECIES_TYRANITAR, TYRANITAR_FORM_BASE, TYRANITAR_FORM_MEGA, 2550, 0, 0, -2 },
    { ITEM_VENUSAURITE, SPECIES_VENUSAUR, VENUSAUR_FORM_BASE, VENUSAUR_FORM_MEGA, 1555, 0, 0, -16 },
    { ITEM_BLASTOISINITE, SPECIES_BLASTOISE, BLASTOISE_FORM_BASE, BLASTOISE_FORM_MEGA, 1011, 15, 0, -20 },
    { ITEM_BEEDRILLITE, SPECIES_BEEDRILL, BEEDRILL_FORM_BASE, BEEDRILL_FORM_MEGA, 405, 0, 0, 5 },
    { ITEM_PIDGEOTITE, SPECIES_PIDGEOT, PIDGEOT_FORM_BASE, PIDGEOT_FORM_MEGA, 505, 0, 0, -17 },
    { ITEM_SLOWBRONITE, SPECIES_SLOWBRO, SLOWBRO_FORM_BASE, SLOWBRO_FORM_MEGA, 1200, 0, 0, -18 },
    { ITEM_GENGARITE, SPECIES_GENGAR,  GENGAR_FORM_BASE, GENGAR_FORM_MEGA, 405, 2, 0, -15 },
    { ITEM_PINSIRITE, SPECIES_PINSIR, PINSIR_FORM_BASE, PINSIR_FORM_MEGA, 590, -4, 0, -12 },
    { ITEM_AMPHAROSITE, SPECIES_AMPHAROS, AMPHAROS_FORM_BASE, AMPHAROS_FORM_MEGA, 615, -8, 0, -9 },
    { ITEM_STEELIXITE, SPECIES_STEELIX, STEELIX_FORM_BASE, STEELIX_FORM_MEGA, 7400, 0, 0, -4 },
    { ITEM_SCIZORITE, SPECIES_SCIZOR, SCIZOR_FORM_BASE, SCIZOR_FORM_MEGA, 1250, 0, 10, -3 },
    { ITEM_HERACRONITE, SPECIES_HERACROSS, HERACROSS_FORM_BASE, HERACROSS_FORM_MEGA, 625, 0, 0, -9 },
    { ITEM_HOUNDOOMINITE, SPECIES_HOUNDOOM, HOUNDOOM_FORM_BASE, HOUNDOOM_FORM_MEGA, 495, 0, 0, -14 },
    { ITEM_SCEPTILITE, SPECIES_SCEPTILE, SCEPTILE_FORM_BASE, SCEPTILE_FORM_MEGA, 552, 19, 0, -15 },
    { ITEM_BLAZIKENITE, SPECIES_BLAZIKEN, BLAZIKEN_FORM_BASE, BLAZIKEN_FORM_MEGA, 520, -4, 3, -8 },
    { ITEM_SWAMPERTITE, SPECIES_SWAMPERT, SWAMPERT_FORM_BASE, SWAMPERT_FORM_MEGA, 1020, 16, 0, -5 },
    { ITEM_SABLENITE, SPECIES_SABLEYE, SABLEYE_FORM_BASE, SABLEYE_FORM_MEGA, 1610, 10, 8, -6 },
    { ITEM_MAWILITE, SPECIES_MAWILE, MAWILE_FORM_BASE, MAWILE_FORM_MEGA, 235, 14, 4, -4 },
    { ITEM_AGGRONITE, SPECIES_AGGRON, AGGRON_FORM_BASE, AGGRON_FORM_MEGA, 3950, 0, 0, 0 },
    { ITEM_MEDICHAMITE, SPECIES_MEDICHAM, MEDICHAM_FORM_BASE, MEDICHAM_FORM_MEGA, 315, 0, 0, -2 },
    { ITEM_MANECTITE, SPECIES_MANECTRIC, MANECTRIC_FORM_BASE, MANECTRIC_FORM_MEGA, 440, 0, 0, -7 },
    { ITEM_BANETTITE, SPECIES_BANETTE, BANETTE_FORM_BASE, BANETTE_FORM_MEGA, 130, 0, 6, 0 },
    { ITEM_ALAKAZITE, SPECIES_ALAKAZAM, ALAKAZAM_FORM_BASE, ALAKAZAM_FORM_MEGA, 480, 0, 12, -4 },
    { ITEM_GYARADOSITE, SPECIES_GYARADOS, GYARADOS_FORM_BASE, GYARADOS_FORM_MEGA, 3050, 0, 5, -7 },
    { ITEM_ABSOLITE, SPECIES_ABSOL, ABSOL_FORM_BASE, ABSOL_FORM_MEGA, 490, 0, 0, -13 },
    { ITEM_ABSOLITE_Z, SPECIES_ABSOL, ABSOL_FORM_BASE, ABSOL_FORM_MEGA_Z, 490, 0, 0, -16 },
    { ITEM_GLALITITE, SPECIES_GLALIE, GLALIE_FORM_BASE, GLALIE_FORM_MEGA, 3502, 0, 8, 0 },
    { ITEM_SALAMENCITE, SPECIES_SALAMENCE, SALAMENCE_FORM_BASE, SALAMENCE_FORM_MEGA, 1126, 0, 0, -7 },
    { ITEM_LOPUNNITE, SPECIES_LOPUNNY, LOPUNNY_FORM_BASE, LOPUNNY_FORM_MEGA, 283, 0, 4, 7 },
    { ITEM_GARCHOMPITE, SPECIES_GARCHOMP, GARCHOMP_FORM_BASE, GARCHOMP_FORM_MEGA, 950, 0, 0, -4 },
    { ITEM_GARCHOMPITE_Z, SPECIES_GARCHOMP, GARCHOMP_FORM_BASE, GARCHOMP_FORM_MEGA_Z, 990, 0, 0, -4 },
    { ITEM_ABOMASITE, SPECIES_ABOMASNOW, ABOMASNOW_FORM_BASE, ABOMASNOW_FORM_MEGA, 1850, 0, 2, -3 },
    { ITEM_GALLADITE, SPECIES_GALLADE, GALLADE_FORM_BASE, GALLADE_FORM_MEGA, 564, 0, 0, -9 },
    { ITEM_GARDEVOIRITE, SPECIES_GARDEVOIR, GARDEVOIR_FORM_BASE, GARDEVOIR_FORM_MEGA, 484, 0, 0, -5 },
    { ITEM_ALTARIANITE, SPECIES_ALTARIA, ALTARIA_FORM_BASE, ALTARIA_FORM_MEGA, 206, 0, 0, 12 },
    { ITEM_SHARPEDONITE, SPECIES_SHARPEDO, SHARPEDO_FORM_BASE, SHARPEDO_FORM_MEGA, 1303, 0, 0, 0 },
    { ITEM_DRAGONINITE, SPECIES_DRAGONITE, DRAGONITE_FORM_BASE, DRAGONITE_FORM_MEGA, 2900, 0, 5, -2 },
    { ITEM_CLEFABLITE, SPECIES_CLEFABLE, CLEFABLE_FORM_BASE, CLEFABLE_FORM_MEGA, 423, -7, 5, -8 },
    { ITEM_FROSLASSITE, SPECIES_FROSLASS, FROSLASS_FORM_BASE, FROSLASS_FORM_MEGA, 296, 0, 0, -1 },
    { ITEM_CHARIZARDITE_Y, SPECIES_CHARIZARD, CHARIZARD_FORM_BASE, CHARIZARD_FORM_MEGA_Y, 1005, 0, 0, -5 },
    { ITEM_CHARIZARDITE_X, SPECIES_CHARIZARD, CHARIZARD_FORM_BASE, CHARIZARD_FORM_MEGA_X, 1105, -10, 0, -5 },
    { ITEM_RAICHUNITE_Y, SPECIES_RAICHU, RAICHU_FORM_BASE, RAICHU_FORM_MEGA_Y, 260, 7, 11, -6 },
    { ITEM_RAICHUNITE_X, SPECIES_RAICHU, RAICHU_FORM_BASE, RAICHU_FORM_MEGA_X, 380, -4, 4, -12 },
    { ITEM_MEWTWONITE_X, SPECIES_MEWTWO, MEWTWO_FORM_BASE, MEWTWO_FORM_MEGA_X, 1270, -5, 2, 0 },
    { ITEM_MEWTWONITE_Y, SPECIES_MEWTWO, MEWTWO_FORM_BASE, MEWTWO_FORM_MEGA_Y, 330, -7, 7, 0 },
    { ITEM_LATIOSITE, SPECIES_LATIOS, LATIOS_FORM_BASE, LATIOS_FORM_MEGA, 700, 0, 0, 5 },
    { ITEM_LATIASITE, SPECIES_LATIAS, LATIAS_FORM_BASE, LATIAS_FORM_MEGA, 520, 0, 4, 13 },
    { ITEM_AERODACTYLITE, SPECIES_AERODACTYL, AERODACTYL_FORM_BASE, AERODACTYL_FORM_MEGA, 790, 2, 0, -3 },
    { ITEM_METAGROSSITE, SPECIES_METAGROSS, METAGROSS_FORM_BASE, METAGROSS_FORM_MEGA, 9429, 0, 8, -17 },
    { ITEM_FERALIGITE, SPECIES_FERALIGATR, FERALIGATR_FORM_BASE, FERALIGATR_FORM_MEGA, 1088, 3, 3, -5 },
    { ITEM_VICTREEBELITE, SPECIES_VICTREEBEL, VICTREEBEL_FORM_BASE, VICTREEBEL_FORM_MEGA, 1255, -15, 0, -10 },
    { ITEM_MEGANIUMITE, SPECIES_MEGANIUM, MEGANIUM_FORM_BASE, MEGANIUM_FORM_MEGA, 2010, 8, 0, -5 },
    { ITEM_SKARMORITE, SPECIES_SKARMORY, SKARMORY_FORM_BASE, SKARMORY_FORM_MEGA, 404, 0, 0, -9 },
    { ITEM_KANGASKHANITE, SPECIES_KANGASKHAN, KANGASKHAN_FORM_BASE, KANGASKHAN_FORM_MEGA, 1000, 0, 0, -10 },
    { ITEM_DARKRANITE, SPECIES_DARKRAI, DARKRAI_FORM_BASE, DARKRAI_FORM_MEGA, 2400, 0, 0, 7 },
    { ITEM_HEATRANITE, SPECIES_HEATRAN, HEATRAN_FORM_BASE, HEATRAN_FORM_MEGA, 5700, 0, 0, -19 },
    { ITEM_STARAPTITE, SPECIES_STARAPTOR, STARAPTOR_FORM_BASE, STARAPTOR_FORM_MEGA, 500, 0, 0, -3 },
    { ITEM_CAMERUPTITE, SPECIES_CAMERUPT, CAMERUPT_FORM_BASE, CAMERUPT_FORM_MEGA, 3205, 0, 0, -22 },
    { ITEM_STARMINITE, SPECIES_STARMIE, STARMIE_FORM_BASE, STARMIE_FORM_MEGA, 800, 0, 5, 0 },
    { ITEM_CHIMECHITE, SPECIES_CHIMECHO, CHIMECHO_FORM_BASE, CHIMECHO_FORM_MEGA, 80, 0, 0, 0 },
};
...
s8 Pokemon_MegaFormBackYShift(u16 monSpecies, u8 monForm)
{
    for (int i = 0; i < NELEMS(sMegaEvolutions); i++) {
        if (sMegaEvolutions[i].species == monSpecies && sMegaEvolutions[i].megaForm == monForm) {
            return sMegaEvolutions[i].backYShift;
        }
    }
...
s8 Pokemon_MegaFormSpriteLift(u16 monSpecies, u8 monForm)
{
    for (int i = 0; i < NELEMS(sMegaEvolutions); i++) {
        if (sMegaEvolutions[i].species == monSpecies && sMegaEvolutions[i].megaForm == monForm) {
            return sMegaEvolutions[i].spriteLift;
        }
    }
...
u8 Pokemon_SanitizeFormId(u16 monSpecies, u8 monForm)
{
    ...
    case SPECIES_BLASTOISE:
        ...
        break;
    case SPECIES_BEEDRILL:
        if (monForm > BEEDRILL_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_PIDGEOT:
        if (monForm > PIDGEOT_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_SLOWBRO:
        if (monForm > SLOWBRO_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_GENGAR:
        ...
        break;
    case SPECIES_PINSIR:
        if (monForm > PINSIR_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_AMPHAROS:
    ...
    case SPECIES_SCIZOR:
        ...
        break;
    case SPECIES_HERACROSS:
        if (monForm > HERACROSS_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_HOUNDOOM:
        if (monForm > HOUNDOOM_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_SCEPTILE:
        if (monForm > SCEPTILE_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_BLAZIKEN:
        if (monForm > BLAZIKEN_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_SWAMPERT:
        if (monForm > SWAMPERT_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_SABLEYE:
        if (monForm > SABLEYE_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_MAWILE:
        if (monForm > MAWILE_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_AGGRON:
        if (monForm > AGGRON_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_MEDICHAM:
        if (monForm > MEDICHAM_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_MANECTRIC:
        if (monForm > MANECTRIC_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_BANETTE:
        if (monForm > BANETTE_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_ALAKAZAM:
    ...
    case SPECIES_GYARADOS:
        ...
        break;
    case SPECIES_ABSOL:
        if (monForm > ABSOL_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_GLALIE:
        if (monForm > GLALIE_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_SALAMENCE:
        if (monForm > SALAMENCE_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_LOPUNNY:
        if (monForm > LOPUNNY_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_GARCHOMP:
        ...
        break;
    case SPECIES_ABOMASNOW:
        if (monForm > ABOMASNOW_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_GALLADE:
        if (monForm > GALLADE_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_GARDEVOIR:
        ...
        break;
    case SPECIES_ALTARIA:
        if (monForm > ALTARIA_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_SHARPEDO:
        if (monForm > SHARPEDO_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_DRAGONITE:
        if (monForm > DRAGONITE_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_CLEFABLE:
        if (monForm > CLEFABLE_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_FROSLASS:
        if (monForm > FROSLASS_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_CHARIZARD:
        if (monForm > CHARIZARD_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_RAICHU:
        if (monForm > RAICHU_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_MEWTWO:
        if (monForm > MEWTWO_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_LATIOS:
        if (monForm > LATIOS_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_LATIAS:
        if (monForm > LATIAS_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_AERODACTYL:
        if (monForm > AERODACTYL_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_METAGROSS:
        if (monForm > METAGROSS_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_FERALIGATR:
        if (monForm > FERALIGATR_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_VICTREEBEL:
        if (monForm > VICTREEBEL_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_MEGANIUM:
        if (monForm > MEGANIUM_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_SKARMORY:
        if (monForm > SKARMORY_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_KANGASKHAN:
        if (monForm > KANGASKHAN_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_DARKRAI:
        if (monForm > DARKRAI_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_HEATRAN:
    ...
    case SPECIES_STARAPTOR:
        ...
        break;
    case SPECIES_CAMERUPT:
        if (monForm > CAMERUPT_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_STARMIE:
        if (monForm > STARMIE_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    case SPECIES_CHIMECHO:
        if (monForm > CHIMECHO_FORM_COUNT - 1) {
            monForm = 0;
        }
        break;
    }
...
s8 LoadPokemonSpriteYOffset(u16 species, u8 gender, u8 face, u8 form, u32 personality)
{
    ...
    case SPECIES_PIDGEOT:
        if (form == PIDGEOT_FORM_MEGA && face == FACE_FRONT) {
            return 1;
        }
    ...
    case SPECIES_SLOWBRO:
        if (form == SLOWBRO_FORM_MEGA && face == FACE_FRONT) {
            return 1;
        }
    ...
    case SPECIES_GENGAR:
        if (form == GENGAR_FORM_MEGA && face == FACE_FRONT) {
            return 8;
        }
    ...
    case SPECIES_PINSIR:
        if (form == PINSIR_FORM_MEGA && face == FACE_FRONT) {
            return 4;
        }
    ...
    case SPECIES_AMPHAROS:
        if (form == AMPHAROS_FORM_MEGA && face == FACE_FRONT) {
            return 3;
        }
    ...
    case SPECIES_HERACROSS:
        if (form == HERACROSS_FORM_MEGA && face == FACE_FRONT) {
            return 1;
        }
    ...
    case SPECIES_HOUNDOOM:
        if (form == HOUNDOOM_FORM_MEGA && face == FACE_FRONT) {
            return 1;
        }
    ...
    case SPECIES_SCEPTILE:
        if (form == SCEPTILE_FORM_MEGA && face == FACE_FRONT) {
            return 1;
        }
    ...
    case SPECIES_BLAZIKEN:
        if (form == BLAZIKEN_FORM_MEGA && face == FACE_FRONT) {
            return 1;
        }
    ...
    case SPECIES_AGGRON:
        if (form == AGGRON_FORM_MEGA && face == FACE_FRONT) {
            return 1;
        }
    ...
    case SPECIES_MANECTRIC:
        if (form == MANECTRIC_FORM_MEGA && face == FACE_FRONT) {
            return 1;
        }
    ...
    case SPECIES_ALAKAZAM:
        if (form == ALAKAZAM_FORM_MEGA && face == FACE_FRONT) {
            return 1;
        }
    ...
    case SPECIES_GYARADOS:
        if (form == GYARADOS_FORM_MEGA && face == FACE_FRONT) {
            return 1;
        }
    ...
    case SPECIES_ABSOL:
        if ((form == ABSOL_FORM_MEGA || form == ABSOL_FORM_MEGA_Z) && face == FACE_FRONT) {
            return 1;
        }
    ...
    case SPECIES_SALAMENCE:
        if (form == SALAMENCE_FORM_MEGA && face == FACE_FRONT) {
            return 1;
        }
    ...
    case SPECIES_CLEFABLE:
        if (form == CLEFABLE_FORM_MEGA && face == FACE_FRONT) {
            return 1;
        }
    ...
    case SPECIES_VICTREEBEL:
        if (form == VICTREEBEL_FORM_MEGA && face == FACE_FRONT) {
            return 1;
        }
    ...
    case SPECIES_MEGANIUM:
        if (form == MEGANIUM_FORM_MEGA && face == FACE_FRONT) {
            return 2;
        }
    ...
    case SPECIES_SKARMORY:
        if (form == SKARMORY_FORM_MEGA && face == FACE_FRONT) {
            return 2;
        }
    ...
    case SPECIES_KANGASKHAN:
        if (form == KANGASKHAN_FORM_MEGA && face == FACE_FRONT) {
            return 8;
        }
    ...
    case SPECIES_CAMERUPT:
        if (form == CAMERUPT_FORM_MEGA && face == FACE_FRONT) {
            return 1;
        }
    ...
    case SPECIES_STARMIE:
        if (form == STARMIE_FORM_MEGA && face == FACE_FRONT) {
            return 8;
        }
    ...
    case SPECIES_CHIMECHO:
        if (form == CHIMECHO_FORM_MEGA && face == FACE_FRONT) {
            return 4;
        }
    ...
    if (face == FACE_BACK) {
        return result + Pokemon_MegaFormBackYShift(species, form);
    }
...
static int Pokemon_GetFormNarcIndex(int monSpecies, int monForm)
{
    ...
    case SPECIES_BLASTOISE:
        if (monForm && monForm <= BLASTOISE_FORM_COUNT - 1) {
            monSpecies = (512 - 1) + monForm;
        }
        break;
    case SPECIES_BEEDRILL:
        if (monForm && monForm <= BEEDRILL_FORM_COUNT - 1) {
            monSpecies = (513 - 1) + monForm;
        }
        break;
    case SPECIES_PIDGEOT:
        if (monForm && monForm <= PIDGEOT_FORM_COUNT - 1) {
            monSpecies = (514 - 1) + monForm;
        }
        break;
    case SPECIES_SLOWBRO:
        if (monForm && monForm <= SLOWBRO_FORM_COUNT - 1) {
            monSpecies = (515 - 1) + monForm;
        }
        break;
    case SPECIES_GENGAR:
        if (monForm && monForm <= GENGAR_FORM_COUNT - 1) {
            monSpecies = (516 - 1) + monForm;
        }
        break;
    case SPECIES_PINSIR:
        if (monForm && monForm <= PINSIR_FORM_COUNT - 1) {
    ...
    case SPECIES_STEELIX:
        if (monForm && monForm <= STEELIX_FORM_COUNT - 1) {
            monSpecies = (519 - 1) + monForm;
        }
        break;
    case SPECIES_SCIZOR:
        if (monForm && monForm <= SCIZOR_FORM_COUNT - 1) {
            monSpecies = (520 - 1) + monForm;
        }
        break;
    case SPECIES_HERACROSS:
        if (monForm && monForm <= HERACROSS_FORM_COUNT - 1) {
            monSpecies = (521 - 1) + monForm;
        }
        break;
    case SPECIES_HOUNDOOM:
        if (monForm && monForm <= HOUNDOOM_FORM_COUNT - 1) {
            monSpecies = (522 - 1) + monForm;
        }
        break;
    case SPECIES_SCEPTILE:
        if (monForm && monForm <= SCEPTILE_FORM_COUNT - 1) {
            monSpecies = (523 - 1) + monForm;
        }
        break;
    case SPECIES_BLAZIKEN:
        if (monForm && monForm <= BLAZIKEN_FORM_COUNT - 1) {
            monSpecies = (524 - 1) + monForm;
        }
        break;
    case SPECIES_SWAMPERT:
        if (monForm && monForm <= SWAMPERT_FORM_COUNT - 1) {
            monSpecies = (525 - 1) + monForm;
        }
        break;
    case SPECIES_SABLEYE:
        if (monForm && monForm <= SABLEYE_FORM_COUNT - 1) {
            monSpecies = (526 - 1) + monForm;
        }
        break;
    case SPECIES_MAWILE:
        if (monForm && monForm <= MAWILE_FORM_COUNT - 1) {
            monSpecies = (527 - 1) + monForm;
        }
        break;
    case SPECIES_AGGRON:
        if (monForm && monForm <= AGGRON_FORM_COUNT - 1) {
            monSpecies = (528 - 1) + monForm;
        }
        break;
    case SPECIES_MEDICHAM:
        if (monForm && monForm <= MEDICHAM_FORM_COUNT - 1) {
            monSpecies = (529 - 1) + monForm;
        }
        break;
    case SPECIES_MANECTRIC:
        if (monForm && monForm <= MANECTRIC_FORM_COUNT - 1) {
            monSpecies = (530 - 1) + monForm;
        }
        break;
    case SPECIES_BANETTE:
        if (monForm && monForm <= BANETTE_FORM_COUNT - 1) {
            monSpecies = (531 - 1) + monForm;
        }
        break;
    case SPECIES_ALAKAZAM:
        if (monForm && monForm <= ALAKAZAM_FORM_COUNT - 1) {
            monSpecies = (532 - 1) + monForm;
        }
        break;
    case SPECIES_GYARADOS:
        if (monForm && monForm <= GYARADOS_FORM_COUNT - 1) {
            monSpecies = (533 - 1) + monForm;
        }
        break;
    case SPECIES_ABSOL:
        if (monForm && monForm <= ABSOL_FORM_COUNT - 1) {
            monSpecies = (534 - 1) + monForm;
        }
        break;
    case SPECIES_GLALIE:
        if (monForm && monForm <= GLALIE_FORM_COUNT - 1) {
            monSpecies = (536 - 1) + monForm;
        }
        break;
    case SPECIES_SALAMENCE:
        if (monForm && monForm <= SALAMENCE_FORM_COUNT - 1) {
            monSpecies = (537 - 1) + monForm;
        }
        break;
    case SPECIES_LOPUNNY:
        if (monForm && monForm <= LOPUNNY_FORM_COUNT - 1) {
            monSpecies = (538 - 1) + monForm;
        }
        break;
    case SPECIES_GARCHOMP:
        if (monForm && monForm <= GARCHOMP_FORM_COUNT - 1) {
            monSpecies = (539 - 1) + monForm;
        }
        break;
    case SPECIES_ABOMASNOW:
        if (monForm && monForm <= ABOMASNOW_FORM_COUNT - 1) {
            monSpecies = (541 - 1) + monForm;
        }
        break;
    case SPECIES_GALLADE:
        if (monForm && monForm <= GALLADE_FORM_COUNT - 1) {
            monSpecies = (542 - 1) + monForm;
        }
        break;
    case SPECIES_GARDEVOIR:
        if (monForm && monForm <= GARDEVOIR_FORM_COUNT - 1) {
            monSpecies = (543 - 1) + monForm;
        }
        break;
    case SPECIES_ALTARIA:
        if (monForm && monForm <= ALTARIA_FORM_COUNT - 1) {
            monSpecies = (544 - 1) + monForm;
        }
        break;
    case SPECIES_SHARPEDO:
        if (monForm && monForm <= SHARPEDO_FORM_COUNT - 1) {
            monSpecies = (545 - 1) + monForm;
        }
        break;
    case SPECIES_DRAGONITE:
        if (monForm && monForm <= DRAGONITE_FORM_COUNT - 1) {
            monSpecies = (546 - 1) + monForm;
        }
        break;
    case SPECIES_CLEFABLE:
        if (monForm && monForm <= CLEFABLE_FORM_COUNT - 1) {
            monSpecies = (547 - 1) + monForm;
        }
        break;
    case SPECIES_FROSLASS:
        if (monForm && monForm <= FROSLASS_FORM_COUNT - 1) {
            monSpecies = (548 - 1) + monForm;
        }
        break;
    case SPECIES_CHARIZARD:
        if (monForm && monForm <= CHARIZARD_FORM_COUNT - 1) {
            monSpecies = (549 - 1) + monForm;
        }
        break;
    case SPECIES_RAICHU:
        if (monForm && monForm <= RAICHU_FORM_COUNT - 1) {
            monSpecies = (551 - 1) + monForm;
        }
        break;
    case SPECIES_MEWTWO:
        if (monForm && monForm <= MEWTWO_FORM_COUNT - 1) {
            monSpecies = (553 - 1) + monForm;
        }
        break;
    case SPECIES_LATIOS:
        if (monForm && monForm <= LATIOS_FORM_COUNT - 1) {
            monSpecies = (555 - 1) + monForm;
        }
        break;
    case SPECIES_LATIAS:
        if (monForm && monForm <= LATIAS_FORM_COUNT - 1) {
            monSpecies = (556 - 1) + monForm;
        }
        break;
    case SPECIES_AERODACTYL:
        if (monForm && monForm <= AERODACTYL_FORM_COUNT - 1) {
            monSpecies = (557 - 1) + monForm;
        }
        break;
    case SPECIES_METAGROSS:
        if (monForm && monForm <= METAGROSS_FORM_COUNT - 1) {
            monSpecies = (558 - 1) + monForm;
        }
        break;
    case SPECIES_FERALIGATR:
        if (monForm && monForm <= FERALIGATR_FORM_COUNT - 1) {
            monSpecies = (559 - 1) + monForm;
        }
        break;
    case SPECIES_VICTREEBEL:
        if (monForm && monForm <= VICTREEBEL_FORM_COUNT - 1) {
            monSpecies = (560 - 1) + monForm;
        }
        break;
    case SPECIES_MEGANIUM:
        if (monForm && monForm <= MEGANIUM_FORM_COUNT - 1) {
            monSpecies = (561 - 1) + monForm;
        }
        break;
    case SPECIES_SKARMORY:
        if (monForm && monForm <= SKARMORY_FORM_COUNT - 1) {
            monSpecies = (562 - 1) + monForm;
        }
        break;
    case SPECIES_KANGASKHAN:
        if (monForm && monForm <= KANGASKHAN_FORM_COUNT - 1) {
            monSpecies = (563 - 1) + monForm;
        }
        break;
    case SPECIES_DARKRAI:
        if (monForm && monForm <= DARKRAI_FORM_COUNT - 1) {
            monSpecies = (564 - 1) + monForm;
        }
        break;
    case SPECIES_HEATRAN:
    ...
    case SPECIES_STARAPTOR:
        ...
        break;
    case SPECIES_CAMERUPT:
        if (monForm && monForm <= CAMERUPT_FORM_COUNT - 1) {
            monSpecies = (567 - 1) + monForm;
        }
        break;
    case SPECIES_STARMIE:
        if (monForm && monForm <= STARMIE_FORM_COUNT - 1) {
            monSpecies = (568 - 1) + monForm;
        }
        break;
    case SPECIES_CHIMECHO:
        if (monForm && monForm <= CHIMECHO_FORM_COUNT - 1) {
            monSpecies = (569 - 1) + monForm;
        }
        break;
    default:
        break;
