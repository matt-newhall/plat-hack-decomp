...
void BuildPokemonSpriteTemplate(PokemonSpriteTemplate *spriteTemplate, u16 species, u8 gender, u8 face, u8 shiny, u8 form, u32 personality)
{
    ...
    case SPECIES_VENUSAUR:
        ...
        spriteTemplate->palette = 439 + shiny + form * 2;
        break;
    ...
    case SPECIES_BLASTOISE:
        ...
        spriteTemplate->palette = 449 + shiny + form * 2;
        break;
...
static const MegaEvolution sMegaEvolutions[] = {
    ...
    { ITEM_CHARIZARDITE_X, SPECIES_CHARIZARD, CHARIZARD_FORM_BASE, CHARIZARD_FORM_MEGA_X, 1105, 0, 0 },
    ...
    { ITEM_METAGROSSITE, SPECIES_METAGROSS, METAGROSS_FORM_BASE, METAGROSS_FORM_MEGA, 9429, 0, 0 },
};
