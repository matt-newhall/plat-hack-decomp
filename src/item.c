...
const ItemArchiveIDs sItemArchiveIDs[] = {
    ...
    [ITEM_BERSERK_GENE] = {
        .dataID = 0x1C6,
        .iconID = berserk_gene_NCGR,
        .paletteID = berserk_gene_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_ROOM_SERVICE] = {
        .dataID = 0x1C7,
    ...
    [ITEM_SCIZORITE] = {
        .dataID = 0x1E4,
        .iconID = scizorite_NCGR,
        .paletteID = scizorite_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_HERACRONITE] = {
        .dataID = 0x1E5,
        .iconID = heracronite_NCGR,
    ...
    [ITEM_ALAKAZITE] = {
        .dataID = 0x1F0,
        .iconID = alakazite_NCGR,
        .paletteID = alakazite_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_GYARADOSITE] = {
        .dataID = 0x1F1,
        .iconID = gyaradosite_NCGR,
    ...
    [ITEM_GLALITITE] = {
        .dataID = 0x1F3,
        .iconID = glalitite_NCGR,
        .paletteID = glalitite_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_SALAMENCITE] = {
        .dataID = 0x1F4,
        .iconID = salamencite_NCGR,
    ...
    [ITEM_CLEFABLITE] = {
        .dataID = 0x1FD,
        .iconID = clefablite_NCGR,
        .paletteID = clefablite_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_FROSLASSITE] = {
        .dataID = 0x1FE,
        .iconID = froslassite_NCGR,
    ...
    [ITEM_CHARIZARDITE_Y] = {
        .dataID = 0x201,
        .iconID = charizardite_y_NCGR,
        .paletteID = charizardite_y_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_RAICHUNITE_Y] = {
        .dataID = 0x202,
        .iconID = raichunite_y_NCGR,
        .paletteID = raichunite_y_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_MEWTWONITE_X] = {
        .dataID = 0x203,
        .iconID = mewtwonite_x_NCGR,
        .paletteID = mewtwonite_x_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_MEWTWONITE_Y] = {
        .dataID = 0x204,
        .iconID = mewtwonite_y_NCGR,
    ...
    [ITEM_METAGROSSITE] = {
        .dataID = 0x208,
        .iconID = metagrossite_NCGR,
        .paletteID = metagrossite_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_CHARIZARDITE_X] = {
        .dataID = 0x209,
        .iconID = charizardite_x_NCGR,
...
static const u16 sTMHMMoves[] = {
    ...
    [TMHM_ID(TM75)] = MOVE_VOLT_SWITCH,
    [TMHM_ID(TM76)] = MOVE_STEALTH_ROCK,
    [TMHM_ID(TM77)] = MOVE_VENOSHOCK,
    [TMHM_ID(TM78)] = MOVE_BODY_PRESS,
...
{
    int maxItem = 0;
    for (int i = ITEM_NONE + 1; i <= NUM_ITEMS; i++) {
        int dataID = Item_FileID(i, ITEM_FILE_TYPE_DATA);
        if (dataID > maxItem) {
            maxItem = dataID;
        }
    }
