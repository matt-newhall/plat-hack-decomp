...
#define MOVE_STATUS_TELEPATHY           (1 << 21)
#define MOVE_STATUS_AIR_BALLOON         (1 << 22)
...
#define MOVE_STATUS_DID_NOT_HIT (MOVE_STATUS_MISSED | MOVE_STATUS_INEFFECTIVE | MOVE_STATUS_FAILED | MOVE_STATUS_LEVITATED     \
    ...
    | MOVE_STATUS_LOST_FOCUS | MOVE_STATUS_WONDER_GUARD | MOVE_STATUS_STURDY | MOVE_STATUS_MAGNET_RISE | MOVE_STATUS_TELEPATHY \
    | MOVE_STATUS_AIR_BALLOON)
...
#define MOVE_STATUS_IMMUNE              (MOVE_STATUS_DID_NOT_AFFECT | MOVE_STATUS_LEVITATED | MOVE_STATUS_MAGNET_RISE | MOVE_STATUS_AIR_BALLOON)
#define MOVE_STATUS_GENERAL_MISS        (MOVE_STATUS_MISSED | MOVE_STATUS_SEMI_INVULNERABLE | MOVE_STATUS_TELEPATHY)
