...
#define SYSCTL_EJECT_PACK_PENDING_0    (1 << 12)
#define SYSCTL_EJECT_PACK_PENDING_1    (1 << 13)
#define SYSCTL_EJECT_PACK_PENDING_2    (1 << 14)
#define SYSCTL_EJECT_PACK_PENDING_3    (1 << 15)
#define SYSCTL_EJECT_PACK_PENDING_MASK (SYSCTL_EJECT_PACK_PENDING_0 | SYSCTL_EJECT_PACK_PENDING_1 | SYSCTL_EJECT_PACK_PENDING_2 | SYSCTL_EJECT_PACK_PENDING_3)
