...
#define VOLATILE_CONDITION_BIDE_0       (1 << 7)
#define VOLATILE_CONDITION_BIDE_1       (1 << 8)
#define VOLATILE_CONDITION_THRASH_0     (1 << 9)
#define VOLATILE_CONDITION_THRASH_1     (1 << 10)
#define VOLATILE_CONDITION_MOVE_LOCKED  (1 << 11)
#define VOLATILE_CONDITION_BIND_0       (1 << 12)
#define VOLATILE_CONDITION_BIND_1       (1 << 13)
#define VOLATILE_CONDITION_BIND_2       (1 << 14)
#define VOLATILE_CONDITION_BIND_3       (1 << 15)
...
#define VOLATILE_CONDITION_BIND      (VOLATILE_CONDITION_BIND_0 | VOLATILE_CONDITION_BIND_1 | VOLATILE_CONDITION_BIND_2 | VOLATILE_CONDITION_BIND_3)
...
#define VOLATILE_CONDITION_BIDE_SHIFT      7
#define VOLATILE_CONDITION_THRASH_SHIFT    9
#define VOLATILE_CONDITION_BIND_SHIFT      12
...
#define SIDE_CONDITION_TAILWIND_2 (1 << 11)
#define SIDE_CONDITION_LUCKY_CHANT_0 (1 << 12)
#define SIDE_CONDITION_LUCKY_CHANT_1 (1 << 13)
#define SIDE_CONDITION_LUCKY_CHANT_2 (1 << 14)
#define SIDE_CONDITION_TAILWIND_3 (1 << 15)
#define SIDE_CONDITION_FLEE_FAILED  (1 << 16)
#define SIDE_CONDITION_STICKY_WEB   (1 << 17)
#define SIDE_CONDITION_AURORA_VEIL  (1 << 18)

#define SIDE_CONDITION_TAILWIND (SIDE_CONDITION_TAILWIND_0 | SIDE_CONDITION_TAILWIND_1 | SIDE_CONDITION_TAILWIND_2 | SIDE_CONDITION_TAILWIND_3)
#define SIDE_CONDITION_LUCKY_CHANT (SIDE_CONDITION_LUCKY_CHANT_0 | SIDE_CONDITION_LUCKY_CHANT_1 | SIDE_CONDITION_LUCKY_CHANT_2)
#define SIDE_CONDITION_PHYSICAL_WALL (SIDE_CONDITION_REFLECT | SIDE_CONDITION_AURORA_VEIL)
#define SIDE_CONDITION_SPECIAL_WALL  (SIDE_CONDITION_LIGHT_SCREEN | SIDE_CONDITION_AURORA_VEIL)
...
#define FIELD_CONDITION_MAGMA_STORM_PERM (1 << 19)
#define FIELD_CONDITION_TRICK_ROOM_PERM (1 << 20)
#define FIELD_CONDITION_TAILWIND_PERM  (1 << 21)
#define FIELD_CONDITION_AURORA_VEIL_PERM  (1 << 22)
#define FIELD_CONDITION_INVERSE_PERM   (1 << 23)
