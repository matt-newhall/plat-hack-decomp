...
static const u8 sTrainerClassGender[] = {
    ...
    [TRAINER_CLASS_ROCKET_GRUNT]            = GENDER_MALE,
    [TRAINER_CLASS_ROCKET_EXECUTIVE]        = GENDER_FEMALE,
    [TRAINER_CLASS_ROCKET_GRUNT_F]          = GENDER_FEMALE,
    [TRAINER_CLASS_LEADER_FALKNER]          = GENDER_MALE,
    [TRAINER_CLASS_LEADER_WHITNEY]          = GENDER_FEMALE,
    [TRAINER_CLASS_COMMANDER_CHARON]        = GENDER_MALE,
    [TRAINER_CLASS_LEADER_JASMINE]          = GENDER_FEMALE,
    [TRAINER_CLASS_LEADER_MORTY]            = GENDER_MALE,
    [TRAINER_CLASS_LEADER_PRYCE]            = GENDER_MALE,
    [TRAINER_CLASS_LEADER_CLAIRE]           = GENDER_FEMALE,
    [TRAINER_CLASS_SBC_LEADER]              = GENDER_FEMALE,
};
// clang-format on
