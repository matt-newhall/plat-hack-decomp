...
static u8 sTrainerClassPrizeMul[] = {
    ...
    [TRAINER_CLASS_TOWER_TYCOON]            = 30,
    [TRAINER_CLASS_MAID]                    = 10,
    [TRAINER_CLASS_HALL_MATRON]             = 30,
    [TRAINER_CLASS_FACTORY_HEAD]            = 30,
    [TRAINER_CLASS_ARCADE_STAR]             = 30,
    [TRAINER_CLASS_CASTLE_VALET]            = 30,
    [TRAINER_CLASS_DP_PLAYER_MALE_2]        = 0,
    [TRAINER_CLASS_DP_PLAYER_FEMALE_2]      = 0,
    [TRAINER_CLASS_PAUL]                    = 25,
    [TRAINER_CLASS_ROCKET_GRUNT]            = 10,
    [TRAINER_CLASS_ROCKET_EXECUTIVE]        = 20,
    ...
    [TRAINER_CLASS_LEADER_JASMINE]          = 30,
    [TRAINER_CLASS_LEADER_MORTY]            = 30,
    [TRAINER_CLASS_LEADER_PRYCE]            = 30,
    [TRAINER_CLASS_LEADER_CLAIRE]           = 30,
    [TRAINER_CLASS_SBC_LEADER]              = 30,
};
// clang-format on
